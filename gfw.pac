...
var domains = {
  ...
  "owl.li": 1,
  "ow.ly": 1,
  "oxfordlearnersdictionaries.com": 1,
  "oxid.it": 1,
  "oyax.com": 1,
  "oyghan.com": 1,
  "ozchinese.com": 1,
...
//var proxy = "__PROXY__";
var proxy = "PROXY 192.168.101.1:8119;";
...
function FindProxyForURL(url, host) {
    ...
    while(1) {
	    ...
	    else if (shExpMatch(host, "*.sci-hub.*"))
		return proxy;
	    else if (shExpMatch(host, "*.scihub.*"))
	    	return proxy;
